...
public class MarksList extends JFrame implements ActionListener {
    ...
    private Object tableHeaders[] = { "Student ID", "Student Name" };
    ...
    public MarksList(Teacher teacher, Course course) {
        ...
        String IDs[] = { "Sadast", "343" };
        String nameArray[] = { "3434", "343" };
        String marksArray[] = { "34656534", "3434" };

        Object rows[][][] = { { IDs }, { nameArray }, { marksArray } };
